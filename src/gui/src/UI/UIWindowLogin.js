...
async function UIWindowLogin (options) {
    ...
    return new Promise(async (resolve) => {
        ...
        h += `<div style="display:flex; align-items:center; gap:10px; margin: 10px 0; font-size:13px; color:var(--color-text-muted);"><div style="flex:1; height:1px; background-color:var(--color-text-muted); opacity:0.3;"></div><span>${ i18n('or') }</span><div style="flex:1; height:1px; background-color:var(--color-text-muted); opacity:0.3;"></div></div>`;
